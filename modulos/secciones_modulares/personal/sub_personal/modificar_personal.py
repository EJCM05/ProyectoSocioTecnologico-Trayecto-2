...
from modulos.secciones_modulares.personal.sub_personal.modificar_tipo_personal import ModificarTipoPersonalVentana
from CTkMessagebox import CTkMessagebox
import sqlite3

class ModificarPersonalVentana():
    def __init__(self, master, cedula):
        self.master = master
        self.cedula_a_modificar = cedula
    
    
    def obtener_info_personal(self):
    ...
    def texto_titulo(self):
        self.texto_seleccion = ctk.CTkLabel(master=self.master,
                                           text="Modificar Información del Personal",
    ...
    def area_input(self):
        lista = self.obtener_info_personal()
        ...
        nombre_personal = ctk.StringVar(value=lista[0])
        apellido_personal = ctk.StringVar(value=lista[1])
        #cedula personal no hay necedidad de buscarlo en la BD
        cedula_personal = ctk.StringVar(value=self.cedula_a_modificar)
        dia_nacimiento = lista[5]
        mes_nacimiento = lista[4]
        año_nacimiento = lista[3]
        genero_personal = lista[6]
        ...
        self.input_apellidos_personal = ctk.CTkEntry(master=self.contenedor_input,
                                    ...
                                    validate="key",
                                    validatecommand=(validacion_letras, '%S'),
                                    textvariable=apellido_personal
                                    )
        ...
        self.input_dia_nacimiento_personal.set(dia_nacimiento)
        ...
        self.input_mes_nacimiento_personal.set(mes_nacimiento)
        ...
        self.input_año_nacimiento_personal.set(año_nacimiento)
        ...
        self.input_genero_personal.set(genero_personal)
    ...
    def continuar(self):
      ...
      ventana = ModificarTipoPersonalVentana(self.master, self.cedula_a_modificar)
      ventana.mostrar()
